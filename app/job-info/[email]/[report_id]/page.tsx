                  ...
                  <tbody>
                    {Array.isArray(skills_match) && skills_match
                      ...
                      .map(({ skill, in_job, in_resume }: any, i: number) => {
                        ...
                        return (
                          <tr key={skill} className="border-b border-gray-200/30 dark:border-gray-700/30 hover:bg-white/50 dark:hover:bg-gray-800/50 transition-colors">
                            <td className="px-6 py-4 font-medium text-gray-900 dark:text-white">{skill}</td>
